...
This package is intended to be reusable inside a larger project.
...
class VelocityMobilityConfiguration:
    ...
    Attributes:
        ...
        max_speed_z: Maximum vertical speed (m/s). Applied to |vz|.
            Typical: 1-8 m/s.
        max_acc_xy: Maximum horizontal acceleration (m/s^2). Applied to the norm of (ax, ay).
            Typical: 2-8 m/s^2.
        max_acc_z: Maximum vertical acceleration (m/s^2). Applied to |az|.
            Typical: 2-10 m/s^2.
