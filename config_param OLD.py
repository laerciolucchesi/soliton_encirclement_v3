...
K_E_TAU: float = 20.0     # spacing error injection gain (e_tau multiplier) (=25)
...
# -----------------------------------------------------------------------------
# Options:
#   "FORCE_U"         -> legacy two-layer: q forces u via K_Q_TO_U * q
#   "MODULATE_KE_TAU" -> new: q modulates K_E_TAU (only increases), and q is NOT injected into u
Q_LAYER_ARCH = "FORCE_U"
...
# -----------------------------------------------------------------------------
# Q -> K_E_TAU gain modulation (only used when Q_LAYER_ARCH == "MODULATE_KE_TAU")
# -----------------------------------------------------------------------------
# Maximum boost fraction for K_E_TAU_eff = K_E_TAU * (1 + Q_MOD_DELTA * m_f)
Q_MOD_DELTA = 0.15
